 ...
 *
 *
 * @method DBase select( string $field = '' )
 * @method DBase between( string $field, string $Between )
 * @method DBase notBetween( string $field, string $Between )
 * @method DBase in( string $field, string $in )
 * @method DBase where( string $field, string $comPar = '', string $val = '' )
 * @method DBase orderBy( string $orderby = '' )
 * @method DBase limit( string $limit )
 * @method DBase orWhere( string $field, string $comPar = '', string $val = '' )
 ...
 * @method DBase leftJoin( $table, $on1, $on2 )
 * @method DBase rightJoin( $table, $on1, $on2 )
 * @method DBase Join( $table, $on1, $on2 )
 * @method DBase fullJoin( $table = '', $on1 = '', $on2 = '' )
 * @method DBase innerJoin( $table = '', $on1 = '', $on2 = '' )
 * @method DBase union( bool $all = false )
 * @method bool|int delete( $table = '', $where = '', $orderby = '', $limit = '' )
 * @method DBase group( $group = '' )
 * @method DataObject|null|Array query( $sql = '' )
 ...
 * @method bool save( $data, $primary_key = '' ) 自动保存
